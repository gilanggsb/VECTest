...
class FavoriteProductListPage extends GetWidget<ProductListController> {
  const FavoriteProductListPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) => GestureDetector(
        ...
        child: Scaffold(
          ...
          body: RefreshIndicator(
            ...
            child: Obx(
              () => (controller.isLoadingRetrieveFavoriteProduct)
                  ? const Center(
      ...
      builder: (context, index) {
        ...
        return Container(
          margin: EdgeInsets.only(
              ...
              bottom: index == controller.favoriteProducts.length - 1 ? 16 : 0),
                  ...
                  Stack(
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          InkWell(
                              onTap: () => controller.removeFavorite(product),
                              child: Padding(
